...
class HandlerServiceClient extends \Grpc\BaseStub {
    ...
    public function AddInbound(\Bluehead\V2ray\Core\App\Proxyman\Command\AddInboundRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/v2ray.core.app.proxyman.command.HandlerService/AddInbound',
        $argument,
    ...
    public function RemoveInbound(\Bluehead\V2ray\Core\App\Proxyman\Command\RemoveInboundRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/v2ray.core.app.proxyman.command.HandlerService/RemoveInbound',
        $argument,
    ...
    public function AlterInbound(\Bluehead\V2ray\Core\App\Proxyman\Command\AlterInboundRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/v2ray.core.app.proxyman.command.HandlerService/AlterInbound',
        $argument,
    ...
    public function AddOutbound(\Bluehead\V2ray\Core\App\Proxyman\Command\AddOutboundRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/v2ray.core.app.proxyman.command.HandlerService/AddOutbound',
        $argument,
    ...
    public function RemoveOutbound(\Bluehead\V2ray\Core\App\Proxyman\Command\RemoveOutboundRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/v2ray.core.app.proxyman.command.HandlerService/RemoveOutbound',
        $argument,
    ...
    public function AlterOutbound(\Bluehead\V2ray\Core\App\Proxyman\Command\AlterOutboundRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/v2ray.core.app.proxyman.command.HandlerService/AlterOutbound',
        $argument,
